...
These are my notes on 'SQL for Data Scientists' by Renee M. P. Teate. I've only just started so there's not much here yet.
...
Here's an example of the code I'm using, I'll hide this in the future chapters:
