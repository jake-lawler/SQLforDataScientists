...
This chapter doesn't introduce too much coding concepts. A lot of the example code in this chapter fits straightforwardly into what we've already seen. The purpose of the chapter is instead to suggest approaches to exploring a new data set.   
